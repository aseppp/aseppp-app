...
const Header = () => {
  ...
  return (
    <>
      <div className="max-w-[1920px] overflow-hidden flex justify-between px-7 mt-28 md:mx-16 md:mt-40 md:flex md:justify-between lg:flex lg:items-center lg:justify-between  lg:mx-auto">
        <div className="flex items-center md:gap-10">
          ...
          <div className="social hidden md:flex lg:flex items-center md:gap-3">
            {socialMenu.map((item, key) => (
              <div key={key}>
                <Link href={item.path}>
                  <h1 className="hover:text-[#2c9284] text-[#ffffff]">{item.icon}</h1>
                </Link>
              </div>
            ))}
          </div>
        ...
        <div className="status flex items-center gap-3 ">
          ...
          <h1 className="info text-[#ffffff] text-sm lg:text-lg ">Available For Work</h1>
        </div>
      </div>
    </>
  );
